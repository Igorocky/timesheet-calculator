...
describe("tsCalculate v2", _ => {
    it("returns correct results", _ => {
        ...
        let tsData = `
            ...
            2023-09-12	0	0
        `
        let tsLog = parseTimesheet(tsData)->Belt.Result.getExn->cast
            ...
            [
                {
                    ...
                    amount: 45.5,
                    amountSum: 45.5,
                    amountFormula: "(6 hrs 30 min) * 7.00",
                ...
                },
                {
                    ...
                    amountFormula: "(3 hrs 10 min) * 11.00",
                    regularDurMinutesSum: 390,
                    regularAmountSum: 45.5,
                    overtimeDurMinutesSum: 0,
                    overtimeAmountSum: 0.,
                ...
                },
                {
                    ...
                    amountFormula: "(8 hrs 0 min) * 7.00",
                ...
                },
                {
                    ...
                    amountFormula: "(8 hrs 0 min) * 7.00 + (2 hrs 0 min) * 9.00",
                ...
                },
                {
                    ...
                    amountFormula: "(8 hrs 0 min) * 7.00 + (2 hrs 20 min) * 9.00",
                ...
                },
                {
                    ...
                    amountFormula: "(6 hrs 0 min) * 11.00",
                    regularDurMinutesSum: 1830,
                    regularAmountSum: 213.5,
                    overtimeDurMinutesSum: 260,
                    overtimeAmountSum: 39.,
                ...
                },
                {
                    ...
                    amountFormula: "(10 hrs 40 min) * 11.00",
                    regularDurMinutesSum: 1830,
                    regularAmountSum: 213.5,
                    overtimeDurMinutesSum: 260,
                    overtimeAmountSum: 39.,
